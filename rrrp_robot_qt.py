#!/usr/bin/env python3
"""
Simulação do Robô RRRP para Soldagem - Versão Qt5Agg
...
def animate_trajectory_qt(robot, Q, V=5):
    """
    Anima a trajetória usando robotics toolbox com Qt5Agg
    """
    if robot is None:
        print("Robotics Toolbox não disponível para animação")
        return
    
    print("Animando trajetória com Qt5Agg...")
...
def main():
    ...
    print("Versão Qt5Agg - Equivalente Python do código MATLAB")
    print()
    ...
    if robot and ROBOTICS_TOOLBOX_AVAILABLE:
        print("\nIniciando animação com Robotics Toolbox (Qt5Agg)...")
        animate_trajectory_qt(robot, Q)
    else:
